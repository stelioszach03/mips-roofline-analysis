# Πολλαπλασιασμός δύο τετραγωνικών πινάκων (n=32)
# Υλοποίηση για QtMips με βασικές εντολές

.data
    # Πρώτος πίνακας εισόδου 32x32 (A)
    matrix_a:
    # Γραμμές 1-32 (συμπιεσμένη αναπαράσταση)
    ...
    # Δεύτερος πίνακας εισόδου 32x32 (B)
    matrix_b:
    # Γραμμές 1-32 (συμπιεσμένη αναπαράσταση)
    .word 1:32, 2:32, 3:32, 4:32, 5:32, 6:32, 7:32, 8:32
    .word 9:32, 10:32, 11:32, 12:32, 13:32, 14:32, 15:32, 16:32
    ...
    # Πίνακας αποτελέσματος 32x32 (C = A × B)
...
inner_loop:
    ...
    addiu $12, $1, 4096    # Βάση του B (μετά το A)
...
store_result:
    ...
    addiu $12, $1, 8192    # Βάση του C (μετά το A και B)
